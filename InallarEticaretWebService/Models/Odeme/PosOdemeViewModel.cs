...
namespace InallarEticaretWebService.Models.Odeme
{
    public class PosOdemeViewModel
    {
        ...
        public string? Hata_URL { get; set; } = "https://localhost:7113/Sonuc/PosOdeme";
        public string? Basarili_URL { get; set; } = "https://localhost:7113/Op/PosOdemePos3DS";
