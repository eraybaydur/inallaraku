...
namespace InallarEticaretWebService.Repository
{
    public class TurkPosWSTESTAsyncRepository : ITurkPosWSTESTAsyncRepository
    {
        ...
        public async Task<ST_Genel_Sonuc> BINSanalPosAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string BIN)
        {
            return await client.BIN_SanalPosAsync(G, BIN);
        }
        public async Task<ST_Genel_Sonuc> BINSanalPos2Async(TurkPosWSTEST.ST_WS_Guvenlik G, string BIN)
        {
            return await client.BIN_SanalPos2Async(G, BIN);
        }
        public async Task<ST_Sonuc_DT> IlListeAsync(TurkPosWSTEST.ST_WS_Guvenlik G)
        {
            return await client.Il_ListeAsync(G);
        }
        public async Task<ST_KK_Saklama> KKSaklamaAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string Kart_No, string KK_Sahibi, string KK_No, string KK_SK_Ay, string KK_SK_Yil, string KK_CVV, string Data1, string Data2, string Data3)
        {
            return await client.KK_SaklamaAsync(G, Kart_No, KK_Sahibi, KK_No, KK_SK_Ay, KK_SK_Yil, KK_CVV, Data1, Data2, Data3);
        }
        public async Task<ST_Genel_Sonuc> KKSakliListeAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string Kart_No, string KS_KK_Kisi_ID)
        {
        ...
        public async Task<ST_Genel_Sonuc> MoneyPayIslemSorgulamaAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Siparis_ID, string Tarih_Bas, string Tarih_Bit)
        {
            return await client.MoneyPay_Islem_SorgulamaAsync(G, GUID, Siparis_ID, Tarih_Bas, Tarih_Bit);
        }
        public async Task<IslemIzlemeRes> ParamPazaryeriIslemIzlemeAsync(TurkPosWSTEST.ST_WS_Guvenlik G, IslemIzlemeReq islemIzlemeReq)
        {
        ...
        public async Task<Sonuc_Uyelik> PazaryeriTPAltUyeIsyeriEklemeAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string ETS_GUID, int Tip, string Ad_Soyad, string Unvan, string TC_VN, string Kisi_DogumTarihi, string GSM_No, string IBAN_No, string IBAN_Unvan, string Adres, string Il, string Ilce, string EPosta, string Website, string MCC_Kod, string Yetkili_Kisi_TC, string Yetkili_Kisi_DogumTarihi, string Vergi_Daire, string Bagli_Olunan_Hesap)
        {
        ...
        public async Task<Sonuc_Uyelik> PazaryeriTPAltUyeIsyeriEklemev2Async(TurkPosWSTEST.ST_WS_Guvenlik G, string ETS_GUID, int Tip, string Ad_Soyad, string Unvan, string TC_VN, string Kisi_DogumTarihi, string GSM_No, string IBAN_No, string IBAN_Unvan, string Adres, string Il, string Ilce, string EPosta, string Website, string MCC_Kod, string Yetkili_Kisi_TC, string Yetkili_Kisi_DogumTarihi, string Vergi_Daire, string Bagli_Olunan_Hesap, string SAPId, string MagentoId)
        {
        ...
        public async Task<Sonuc_Uyelik> PazaryeriTPAltUyeIsyeriGuncellemeAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID_AltUyeIsyeri, string Ad_Soyad, string Unvan, string GSM_No, string IBAN_No, string IBAN_Unvan, string Adres, string Il, string Ilce, string EPosta, string Website, string MCC_Kod, string Vergi_Daire, string Bagli_Olunan_Hesap)
        {
        ...
        public async Task<Sonuc_Uyelik> PazaryeriTPAltUyeIsyeriGuncellemev2Async(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID_AltUyeIsyeri, string Ad_Soyad, string Unvan, string GSM_No, string IBAN_No, string IBAN_Unvan, string Adres, string Il, string Ilce, string EPosta, string Website, string MCC_Kod, string Vergi_Daire, string Bagli_Olunan_Hesap, string SAPId, string MagentoId)
        {
        ...
        public async Task<Sonuc_Uyelik_Liste> PazaryeriTPAltUyeIsyeriListeAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string ETS_GUID, string Limit, string Skip)
        {
            return await client.Pazaryeri_TP_AltUyeIsyeri_ListeAsync(G, ETS_GUID, Limit, Skip);
        }
        public async Task<object> PazaryeriTPAltUyeIsyeriSilmeAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID_AltUyeIsyeri)
        {
            return await client.Pazaryeri_TP_AltUyeIsyeri_SilmeAsync(G, GUID_AltUyeIsyeri);
        }
        public async Task<STC_SonucII> PazaryeriTPIptalIadeAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string PYSiparis_GUID, string GUID, string Durum, string Siparis_ID, double SiparisTutar, double OdenecekTutar)
        {
            return await client.Pazaryeri_TP_Iptal_IadeAsync(G, PYSiparis_GUID, GUID, Durum, Siparis_ID, SiparisTutar, OdenecekTutar);
        }
        public async Task<ST_Genel_Sonuc> PazaryeriTPIslemSorgulamaAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string ETS_GUID, string GUID_AltUyeIsyeri, string PYSiparis_GUID, long SanalPOS_Islem_ID, string Tarih_Bas, string Tarih_Bit)
        {
        ...
        public async Task<SE_Sonuc> PazaryeriTPSiparisDetayEkleAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string ETS_GUID, string Tutar_Urun, string Tutar_Odenecek, string SanalPOS_Islem_ID, string GUID_AltUyeIsyeri)
        {
        ...
        public async Task<ST_Genel_Sonuc> PosPluginBildirimAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string ETS_GUID, string Domain_Adres, string Yazilim_Bilgisi, string Yazilim_Surum_Bilgisi)
        {
        ...
        public async Task<ST_TP_Islem_Odeme> TPIslemCheckoutOdemeWNSAsync(TurkPosWSTEST.ST_WS_Guvenlik G, int SanalPOS_ID, string GUID, string KK_Sahibi, string KK_No, string KK_SK_Ay, string KK_SK_Yil, string KK_CVC, string KK_Sahibi_GSM, string Hata_URL, string Basarili_URL, string Siparis_ID, string Siparis_Aciklama, int Taksit, string Islem_Tutar, string Toplam_Tutar, string Islem_Hash, string Islem_Guvenlik_Tip, string Islem_ID, string IPAdr, string Ref_URL, string Data1, string Data2, string Data3, string Data4, string Data5, string Firma_IPAdr)
        {
        ...
        public async Task<ST_Sonuc> TPIslemDekontGonderAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Dekont_ID, string E_Posta)
        {
            return await client.TP_Islem_Dekont_GonderAsync(G, GUID, Dekont_ID, E_Posta);
        }
        public async Task<ST_Sonuc> TPIslemIptalIadeAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Durum, string Dekont_ID)
        {
            return await client.TP_Islem_Iptal_IadeAsync(G, GUID, Durum, Dekont_ID);
        }
        public async Task<ST_Sonuc_II> TPIslemIptalIade2Async(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Durum, string Siparis_ID)
        {
            return await client.TP_Islem_Iptal_Iade2Async(G, GUID, Durum, Siparis_ID);
        }
        public async Task<ST_Sonuc> TPIslemIptalIadeKismiAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Durum, string Dekont_ID, double Tutar)
        {
            return await client.TP_Islem_Iptal_Iade_KismiAsync(G, GUID, Durum, Dekont_ID, Tutar);
        }
        public async Task<ST_Sonuc_II> TPIslemIptalIadeKismi2Async(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Durum, string Siparis_ID, double Tutar)
        {
            return await client.TP_Islem_Iptal_Iade_Kismi2Async(G, GUID, Durum, Siparis_ID, Tutar);
        }
        public async Task<ST_Sonuc_II> TPIslemIptalIadeKismi3Async(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Durum, string Siparis_ID, double Tutar, string Ref_No)
        {
            return await client.TP_Islem_Iptal_Iade_Kismi3Async(G, GUID, Durum, Siparis_ID, Tutar, Ref_No);
        }
        public async Task<ST_Sonuc4> TPIslemIptalIadeKismi4Async(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Durum, string Siparis_ID, double Tutar)
        {
            return await client.TP_Islem_Iptal_Iade_Kismi4Async(G, GUID, Durum, Siparis_ID, Tutar);
        }
        public async Task<ST_Sonuc_WP> TPIslemIptalIadeKismiWPAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Durum, string Siparis_ID, double Tutar, string Ref_No)
        {
            return await client.TP_Islem_Iptal_Iade_Kismi_WPAsync(G, GUID, Durum, Siparis_ID, Tutar, Ref_No);
        }
        public async Task<ST_Sonuc> TPIslemIptalOnProvAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Prov_ID, string Siparis_ID)
        {
            return await client.TP_Islem_Iptal_OnProvAsync(G, GUID, Prov_ID, Siparis_ID);
        }
        public async Task<ST_Genel_Sonuc> TPIslemIzlemeAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Tarih_Bas, string Tarih_Bit, string Islem_Tip, string Islem_Durum)
        {
            return await client.TP_Islem_IzlemeAsync(G, GUID, Tarih_Bas, Tarih_Bit, Islem_Tip, Islem_Durum);
        }
        public async Task<ST_TP_Islem_Odeme> TPIslemOdemeAsync(TurkPosWSTEST.ST_WS_Guvenlik G, int SanalPOS_ID, string GUID, string KK_Sahibi, string KK_No, string KK_SK_Ay, string KK_SK_Yil, string KK_CVC, string KK_Sahibi_GSM, string Hata_URL, string Basarili_URL, string Siparis_ID, string Siparis_Aciklama, int Taksit, string Islem_Tutar, string Toplam_Tutar, string Islem_Hash, string Islem_ID, string IPAdr, string Ref_URL, string Data1, string Data2, string Data3, string Data4, string Data5)
        {
        ...
        public async Task<ST_TP_Islem_Odeme_OnProv> TPIslemOdemeOnProvAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string KK_Sahibi, string KK_No, string KK_SK_Ay, string KK_SK_Yil, string KK_CVC, string KK_Sahibi_GSM, string Hata_URL, string Basarili_URL, string Siparis_ID, string Siparis_Aciklama, string Islem_Tutar, string Toplam_Tutar, string Islem_Hash, string Islem_Guvenlik_Tip, string Islem_ID, string IPAdr, string Ref_URL, string Data1, string Data2, string Data3, string Data4, string Data5)
        {
        ...
        public async Task<ST_TP_Islem_Odeme_OnProvKapa> TPIslemOdemeOnProvKapaAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Prov_ID, string Prov_Tutar, string Siparis_ID)
        {
            return await client.TP_Islem_Odeme_OnProv_KapaAsync(G, GUID, Prov_ID, Prov_Tutar, Siparis_ID);
        }
        public async Task<ST_TP_Islem_Odeme_OnProv> TPIslemOdemeOnProvWKSAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string KS_Kart_No, string KK_GUID, string KK_Sahibi_GSM, string Hata_URL, string Basarili_URL, string Siparis_ID, string Siparis_Aciklama, string Islem_Tutar, string Toplam_Tutar, string Islem_Hash, string Islem_Guvenlik_Tip, string Islem_ID, string IPAdr, string Ref_URL, string Data1, string Data2, string Data3, string Data4, string Data5)
        {
        ...
        public async Task<ST_WMD_UCD> TPIslemOdemeOnProvWMDAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string KK_Sahibi, string KK_No, string KK_SK_Ay, string KK_SK_Yil, string KK_CVC, string KK_Sahibi_GSM, string Hata_URL, string Basarili_URL, string Siparis_ID, string Siparis_Aciklama, string Islem_Tutar, string Toplam_Tutar, string Islem_Hash, string Islem_Guvenlik_Tip, string Islem_ID, string IPAdr, string Ref_URL, string Data1, string Data2, string Data3, string Data4, string Data5, int Taksit)
        {
        ...
        public async Task<ST_TP_Islem_Odeme> TPIslemOdemeWDAsync(TurkPosWSTEST.ST_WS_Guvenlik G, int Doviz_Kodu, string GUID, string KK_Sahibi, string KK_No, string KK_SK_Ay, string KK_SK_Yil, string KK_CVC, string KK_Sahibi_GSM, string Hata_URL, string Basarili_URL, string Siparis_ID, string Siparis_Aciklama, string Islem_Tutar, string Toplam_Tutar, string Islem_Hash, string Islem_Guvenlik_Tip, string Islem_ID, string IPAdr, string Ref_URL, string Data1, string Data2, string Data3, string Data4, string Data5)
        {
        ...
        public async Task<ST_TP_Islem_Odeme> TPIslemOdemeWKSAsync(TurkPosWSTEST.ST_WS_Guvenlik G, int SanalPOS_ID, string GUID, string KS_Kart_No, string KK_GUID, string KK_Sahibi_GSM, string Hata_URL, string Basarili_URL, string Siparis_ID, string Siparis_Aciklama, int Taksit, string Islem_Tutar, string Toplam_Tutar, string Islem_Hash, string Islem_Guvenlik_Tip, string Islem_ID, string IPAdr, string Ref_URL, string Data1, string Data2, string Data3, string Data4, string Data5)
        {
        ...
        public async Task<ST_TP_Islem_Odeme> TPIslemOdemeWNSAsync(TurkPosWSTEST.ST_WS_Guvenlik G, int SanalPOS_ID, string GUID, string KK_Sahibi, string KK_No, string KK_SK_Ay, string KK_SK_Yil, string KK_CVC, string KK_Sahibi_GSM, string Hata_URL, string Basarili_URL, string Siparis_ID, string Siparis_Aciklama, int Taksit, string Islem_Tutar, string Toplam_Tutar, string Islem_Hash, string Islem_Guvenlik_Tip, string Islem_ID, string IPAdr, string Ref_URL, string Data1, string Data2, string Data3, string Data4, string Data5, string Firma_IPAdr)
        {
        ...
        public async Task<ST_Genel_Sonuc> TPIslemSorgulamaAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Dekont_ID, string Siparis_ID, string Islem_ID)
        {
            return await client.TP_Islem_SorgulamaAsync(G, GUID, Dekont_ID, Siparis_ID, Islem_ID);
        }
        public async Task<ST_Genel_Sonuc2> TPIslemSorgulama4Async(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Dekont_ID, string Siparis_ID, string Islem_ID)
        {
            return await client.TP_Islem_Sorgulama4Async(G, GUID, Dekont_ID, Siparis_ID, Islem_ID);
        }
        public async Task<ST_Genel_Sonuc3> TPIslemSorgulama5Async(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Dekont_ID, string Siparis_ID, string Islem_ID)
        {
            return await client.TP_Islem_Sorgulama5Async(G, GUID, Dekont_ID, Siparis_ID, Islem_ID);
        }
        public async Task<ST_WMD_UCD> TPIslemSorgulama6Async(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Siparis_ID)
        {
            return await client.TP_Islem_Sorgulama6Async(G, GUID, Siparis_ID);
        }
        public async Task<ST_Islem_Sorgulama_WP> TPIslemSorgulamaWPAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Dekont_ID, string Siparis_ID, string Islem_ID, string Ref_No)
        {
            return await client.TP_Islem_Sorgulama_WPAsync(G, GUID, Dekont_ID, Siparis_ID, Islem_ID, Ref_No);
        }
        public async Task<ST_TP_Islem_Odeme> TPKKVerifyAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string KK_No, string KK_SK_Ay, string KK_SK_Yil, string KK_CVC, string Return_URL, string Data1, string Data2, string Data3, string Data4, string Data5)
        {
        ...
        public async Task<ST_Genel_Sonuc> TPMutabakatDetayAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Tarih)
        {
            return await client.TP_Mutabakat_DetayAsync(G, GUID, Tarih);
        }
        public async Task<ST_Genel_Sonuc> TPMutabakatOzetAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Tarih_Bas, string Tarih_Bit)
        {
            return await client.TP_Mutabakat_OzetAsync(G, GUID, Tarih_Bas, Tarih_Bit);
        }
        public async Task<ST_Genel_Sonuc> TPOzelOranListeAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID)
        {
            return await client.TP_Ozel_Oran_ListeAsync(G, GUID);
        }
        public async Task<ST_Sonuc> TPOzelOranSKGuncelleAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Ozel_Oran_SK_ID, string MO_1, string MO_2, string MO_3, string MO_4, string MO_5, string MO_6, string MO_7, string MO_8, string MO_9, string MO_10, string MO_11, string MO_12)
        {
        ...
        public async Task<ST_Genel_Sonuc> TPOzelOranSKListeAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID)
        {
            return await client.TP_Ozel_Oran_SK_ListeAsync(G, GUID);
        }
        public async Task<ST_WMD_Pay> TPWMDPayAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string UCD_MD, string Islem_GUID, string Siparis_ID)
        {
            return await client.TP_WMD_PayAsync(G, GUID, UCD_MD, Islem_GUID, Siparis_ID);
        }
        public async Task<ST_WMD_UCD> TPWMDUCDAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string KK_Sahibi, string KK_No, string KK_SK_Ay, string KK_SK_Yil, string KK_CVC, string KK_Sahibi_GSM, string Hata_URL, string Basarili_URL, string Siparis_ID, string Siparis_Aciklama, int Taksit, string Islem_Tutar, string Toplam_Tutar, string Islem_Hash, string Islem_Guvenlik_Tip, string Islem_ID, string IPAdr, string Ref_URL, string Data1, string Data2, string Data3, string Data4, string Data5)
        {
        ...
        public async Task<ST_WMD_UCD> TPWMDUCDPuanAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string KK_Sahibi, string KK_No, string KK_SK_Ay, string KK_SK_Yil, string KK_CVC, string KK_Sahibi_GSM, string Hata_URL, string Basarili_URL, string Siparis_ID, string Siparis_Aciklama, int Taksit, string Islem_Tutar, string Toplam_Tutar, string Islem_Hash, string Islem_Guvenlik_Tip, string Islem_ID, string IPAdr, string Ref_URL, string Data1, string Data2, string Data3, string Data4, string Data5, string Pos_ID, string Islem_Tip)
        {
        ...
        public async Task<ST_WMD_UCD> TPWMDUCDWPAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string KK_Sahibi, string KK_No, string KK_SK_Ay, string KK_SK_Yil, string KK_CVC, string KK_Sahibi_GSM, string Hata_URL, string Basarili_URL, string Siparis_ID, string Siparis_Aciklama, int Taksit, string Islem_Tutar, string Toplam_Tutar, string Islem_Hash, string Islem_Guvenlik_Tip, string Islem_ID, string IPAdr, string Ref_URL, string Data1, string Data2, string Data3, string Data4, string Data5, string Puan, string Pos_ID, string Islem_Tip)
        {
        ...
        public async Task<ST_WMD_UCD_v2> TPWMDUCDv2Async(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string KK_Sahibi, string KK_No, string KK_SK_Ay, string KK_SK_Yil, string KK_CVC, string KK_Sahibi_GSM, string Hata_URL, string Basarili_URL, string Siparis_ID, string Siparis_Aciklama, int Taksit, string Islem_Tutar, string Toplam_Tutar, string Islem_Hash, string Islem_Guvenlik_Tip, string Islem_ID, string IPAdr, string Ref_URL, string Data1, string Data2, string Data3, string Data4, string Data5)
        {
        ...
        public async Task<ST_Vadeli_Islem_Izleme_Sonuc> VadeliIslemIzlemeAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Tarih_Bas, string Tarih_Bit, string Siparis_No)
        {
