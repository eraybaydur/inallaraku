...
namespace InallarEticaretWebService.Repository.Interfaces
{
    public interface ITurkPosWSTESTAsyncRepository
    {
        ...
        /// <param name="G">TurkPosWSTEST.ST_WS_Guvenlik Nesnesi (Zorunlu)</param>
        ///     TurkPosWSTEST.ST_WS_Guvenlik Nesnesi:
        ...
        public Task<ST_Genel_Sonuc> BINSanalPosAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string BIN);
        public Task<ST_Genel_Sonuc> BINSanalPos2Async(TurkPosWSTEST.ST_WS_Guvenlik G, string BIN);
        ...
        ///             Plaka: İl Kodu
        ///             IL: İl Adı
        public Task<ST_Sonuc_DT> IlListeAsync(TurkPosWSTEST.ST_WS_Guvenlik G);
        ...
        ///         Sonuc: İşlem Sonucu
        ///         Sonuc_Str: İşlem Sonucunun Açıklaması
        public Task<ST_KK_Saklama> KKSaklamaAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string Kart_No, string KK_Sahibi, string KK_No, string KK_SK_Ay, string KK_SK_Yil, string KK_CVV, string Data1, string Data2, string Data3);
        ...
        ///         Sonuc: İşlem Sonucu
        ///         Sonuc_Str: İşlem Sonucunun Açıklaması
        public Task<ST_Genel_Sonuc> KKSakliListeAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string Kart_No, string KS_KK_Kisi_ID);
        ...
        public Task<ST_Genel_Sonuc> MoneyPayIslemSorgulamaAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Siparis_ID, string Tarih_Bas, string Tarih_Bit);
        public Task<IslemIzlemeRes> ParamPazaryeriIslemIzlemeAsync(TurkPosWSTEST.ST_WS_Guvenlik G, IslemIzlemeReq islemIzlemeReq);
        ...
        ///         Sonuc_Str: İşlem Sonucunun Açıklaması
        ///         GUID_AltUyeIsyeri: Alt Üye İş Yerinin GUID Değeri
        public Task<Sonuc_Uyelik_Liste> PazaryeriTPAltUyeIsyeriListeAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string ETS_GUID, string Limit, string Skip);
        ...
        ///             Sonuc_Str: İşlem Sonucunun Açıklaması
        ///             GUID_AltUyeIsyeri: Alt Üye İş Yerinin GUID Değeri
        public Task<object> PazaryeriTPAltUyeIsyeriSilmeAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID_AltUyeIsyeri);
        ...
        public Task<STC_SonucII> PazaryeriTPIptalIadeAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string PYSiparis_GUID, string GUID, string Durum, string Siparis_ID, double SiparisTutar, double OdenecekTutar);
        /// <summary>Pazaryerinde üye işyerinin belirli tarihler arasındaki işlemleri sorgulaması işlemini uygular.</summary>
        /// <param name="G">TurkPosWSTEST.ST_WS_Guvenlik Nesnesi (Zorunlu)</param>
        ///     TurkPosWSTEST.ST_WS_Guvenlik Nesnesi:
        ///         CLIENT_CODE: Terminal ID (Zorunlu)
        ...
        ///         Sonuc: İşlem Sonucu
        ///         Sonuc_Str: İşlem Sonucunun Açıklaması
        public Task<ST_Genel_Sonuc> PazaryeriTPIslemSorgulamaAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string ETS_GUID, string GUID_AltUyeIsyeri, string PYSiparis_GUID, long SanalPOS_Islem_ID, string Tarih_Bas, string Tarih_Bit);
        ...
        ///         Yeni_Odenecek_Tutar: Yeni Ödenecek Tutar
        public Task<SE_Sonuc> PazaryeriTPSiparisDetayEkleAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string ETS_GUID, string Tutar_Urun, string Tutar_Odenecek, string SanalPOS_Islem_ID, string GUID_AltUyeIsyeri);
        ...
        ///         Sonuc: İşlem Sonucu
        ///         Sonuc_Str: İşlem Sonucunun Açıklaması
        public Task<STC_Sonuc> PazaryeriTPSiparisOnayAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string PYSiparis_GUID, string Durum);
        ...
        public Task<ST_TP_Islem_Odeme> TPIslemCheckoutOdemeWNSAsync(TurkPosWSTEST.ST_WS_Guvenlik G, int SanalPOS_ID, string GUID, string KK_Sahibi, string KK_No, string KK_SK_Ay, string KK_SK_Yil, string KK_CVC, string KK_Sahibi_GSM, string Hata_URL, string Basarili_URL, string Siparis_ID, string Siparis_Aciklama, int Taksit, string Islem_Tutar, string Toplam_Tutar, string Islem_Hash, string Islem_Guvenlik_Tip, string Islem_ID, string IPAdr, string Ref_URL, string Data1, string Data2, string Data3, string Data4, string Data5, string Firma_IPAdr);
        ...
        ///         Sonuc_Str: İşlem Sonucunun Açıklaması
        ///         Banka_Sonuc_Kod: Bankanın Sonuç Kodu
        public Task<ST_Sonuc> TPIslemDekontGonderAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Dekont_ID, string E_Posta);
        public Task<ST_Sonuc> TPIslemIptalIadeAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Durum, string Dekont_ID);
        public Task<ST_Sonuc_II> TPIslemIptalIade2Async(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Durum, string Siparis_ID);
        public Task<ST_Sonuc> TPIslemIptalIadeKismiAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Durum, string Dekont_ID, double Tutar);
        ...
        public Task<ST_Sonuc_II> TPIslemIptalIadeKismi2Async(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Durum, string Siparis_ID, double Tutar);
        public Task<ST_Sonuc_II> TPIslemIptalIadeKismi3Async(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Durum, string Siparis_ID, double Tutar, string Ref_No);
        public Task<ST_Sonuc4> TPIslemIptalIadeKismi4Async(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Durum, string Siparis_ID, double Tutar);
        public Task<ST_Sonuc_WP> TPIslemIptalIadeKismiWPAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Durum, string Siparis_ID, double Tutar, string Ref_No);
        ...
        ///         Sonuc_Str: İşlem Sonucunun Açıklaması
        ///         Banka_Sonuc_Kod: Bankanın Sonuç Kodu
        public Task<ST_Sonuc> TPIslemIptalOnProvAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Prov_ID, string Siparis_ID);
        ...
        ///         Sonuc: İşlem Sonucu
        ///         Sonuc_Str: İşlem Sonucunun Açıklaması
        public Task<ST_Genel_Sonuc> TPIslemIzlemeAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Tarih_Bas, string Tarih_Bit, string Islem_Tip, string Islem_Durum);
        public Task<ST_TP_Islem_Odeme> TPIslemOdemeAsync(TurkPosWSTEST.ST_WS_Guvenlik G, int SanalPOS_ID, string GUID, string KK_Sahibi, string KK_No, string KK_SK_Ay, string KK_SK_Yil, string KK_CVC, string KK_Sahibi_GSM, string Hata_URL, string Basarili_URL, string Siparis_ID, string Siparis_Aciklama, int Taksit, string Islem_Tutar, string Toplam_Tutar, string Islem_Hash, string Islem_ID, string IPAdr, string Ref_URL, string Data1, string Data2, string Data3, string Data4, string Data5);
        ...
        ///         Bank_Extra: Banka Extra Değeri
        ///         Bank_HostRefNum: Bankanın RRN Değeri
        public Task<ST_TP_Islem_Odeme_OnProvKapa> TPIslemOdemeOnProvKapaAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Prov_ID, string Prov_Tutar, string Siparis_ID);
        ...
        public Task<ST_WMD_UCD> TPIslemOdemeOnProvWMDAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string KK_Sahibi, string KK_No, string KK_SK_Ay, string KK_SK_Yil, string KK_CVC, string KK_Sahibi_GSM, string Hata_URL, string Basarili_URL, string Siparis_ID, string Siparis_Aciklama, string Islem_Tutar, string Toplam_Tutar, string Islem_Hash, string Islem_Guvenlik_Tip, string Islem_ID, string IPAdr, string Ref_URL, string Data1, string Data2, string Data3, string Data4, string Data5, int Taksit);
        ...
        ///         Komisyon_Oran: Komisyon Oranı
        public Task<ST_TP_Islem_Odeme> TPIslemOdemeWDAsync(TurkPosWSTEST.ST_WS_Guvenlik G, int Doviz_Kodu, string GUID, string KK_Sahibi, string KK_No, string KK_SK_Ay, string KK_SK_Yil, string KK_CVC, string KK_Sahibi_GSM, string Hata_URL, string Basarili_URL, string Siparis_ID, string Siparis_Aciklama, string Islem_Tutar, string Toplam_Tutar, string Islem_Hash, string Islem_Guvenlik_Tip, string Islem_ID, string IPAdr, string Ref_URL, string Data1, string Data2, string Data3, string Data4, string Data5);
        public Task<ST_TP_Islem_Odeme> TPIslemOdemeWKSAsync(TurkPosWSTEST.ST_WS_Guvenlik G, int SanalPOS_ID, string GUID, string KS_Kart_No, string KK_GUID, string KK_Sahibi_GSM, string Hata_URL, string Basarili_URL, string Siparis_ID, string Siparis_Aciklama, int Taksit, string Islem_Tutar, string Toplam_Tutar, string Islem_Hash, string Islem_Guvenlik_Tip, string Islem_ID, string IPAdr, string Ref_URL, string Data1, string Data2, string Data3, string Data4, string Data5);
        public Task<ST_TP_Islem_Odeme> TPIslemOdemeWNSAsync(TurkPosWSTEST.ST_WS_Guvenlik G, int SanalPOS_ID, string GUID, string KK_Sahibi, string KK_No, string KK_SK_Ay, string KK_SK_Yil, string KK_CVC, string KK_Sahibi_GSM, string Hata_URL, string Basarili_URL, string Siparis_ID, string Siparis_Aciklama, int Taksit, string Islem_Tutar, string Toplam_Tutar, string Islem_Hash, string Islem_Guvenlik_Tip, string Islem_ID, string IPAdr, string Ref_URL, string Data1, string Data2, string Data3, string Data4, string Data5, string Firma_IPAdr);
        public Task<ST_Genel_Sonuc> TPIslemSorgulamaAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Dekont_ID, string Siparis_ID, string Islem_ID);
        ...
        ///         Sonuc: İşlem Sonucu
        ///         Sonuc_Str: İşlem Sonucunun Açıklaması
        public Task<ST_Genel_Sonuc2> TPIslemSorgulama4Async(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Dekont_ID, string Siparis_ID, string Islem_ID);
        public Task<ST_Genel_Sonuc3> TPIslemSorgulama5Async(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Dekont_ID, string Siparis_ID, string Islem_ID);
        public Task<ST_WMD_UCD> TPIslemSorgulama6Async(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Siparis_ID);
        public Task<ST_Islem_Sorgulama_WP> TPIslemSorgulamaWPAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Dekont_ID, string Siparis_ID, string Islem_ID, string Ref_No);
        ...
        ///         Siparis_ID: Sipariş ID'si
        ///         Komisyon_Oran: Komisyon Oranı
        public Task<ST_TP_Islem_Odeme> TPKKVerifyAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string KK_No, string KK_SK_Ay, string KK_SK_Yil, string KK_CVC, string Return_URL, string Data1, string Data2, string Data3, string Data4, string Data5);
        ...
        ///         Sonuc: İşlem Sonucu
        ///         Sonuc_Str: İşlem Sonucunun Açıklaması
        public Task<ST_Genel_Sonuc> TPMutabakatDetayAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Tarih);
        ...
        ///         Sonuc: İşlem Sonucu
        ///         Sonuc_Str: İşlem Sonucunun Açıklaması
        public Task<ST_Genel_Sonuc> TPMutabakatOzetAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Tarih_Bas, string Tarih_Bit);
        ...
        ///         Sonuc: İşlem Sonucu
        ///         Sonuc_Str: İşlem Sonucunun Açıklaması
        public Task<ST_Genel_Sonuc> TPOzelOranListeAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID);
        ...
        ///         Sonuc_Str: İşlem Sonucunun Açıklaması
        ///         Banka_Sonuc_Kod: Bankanın Sonuç Kodu
        public Task<ST_Sonuc> TPOzelOranSKGuncelleAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Ozel_Oran_SK_ID, string MO_1, string MO_2, string MO_3, string MO_4, string MO_5, string MO_6, string MO_7, string MO_8, string MO_9, string MO_10, string MO_11, string MO_12);
        ...
        ///         Sonuc: İşlem Sonucu
        ///         Sonuc_Str: İşlem Sonucunun Açıklaması
        public Task<ST_Genel_Sonuc> TPOzelOranSKListeAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID);
        public Task<ST_WMD_Pay> TPWMDPayAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string UCD_MD, string Islem_GUID, string Siparis_ID);
        ...
        public Task<ST_WMD_UCD> TPWMDUCDPuanAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string KK_Sahibi, string KK_No, string KK_SK_Ay, string KK_SK_Yil, string KK_CVC, string KK_Sahibi_GSM, string Hata_URL, string Basarili_URL, string Siparis_ID, string Siparis_Aciklama, int Taksit, string Islem_Tutar, string Toplam_Tutar, string Islem_Hash, string Islem_Guvenlik_Tip, string Islem_ID, string IPAdr, string Ref_URL, string Data1, string Data2, string Data3, string Data4, string Data5, string Pos_ID, string Islem_Tip);
        public Task<ST_WMD_UCD> TPWMDUCDWPAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string KK_Sahibi, string KK_No, string KK_SK_Ay, string KK_SK_Yil, string KK_CVC, string KK_Sahibi_GSM, string Hata_URL, string Basarili_URL, string Siparis_ID, string Siparis_Aciklama, int Taksit, string Islem_Tutar, string Toplam_Tutar, string Islem_Hash, string Islem_Guvenlik_Tip, string Islem_ID, string IPAdr, string Ref_URL, string Data1, string Data2, string Data3, string Data4, string Data5, string Puan, string Pos_ID, string Islem_Tip);
        ...
        public Task<ST_Vadeli_Islem_Izleme_Sonuc> VadeliIslemIzlemeAsync(TurkPosWSTEST.ST_WS_Guvenlik G, string GUID, string Tarih_Bas, string Tarih_Bit, string Siparis_No);
    }
}
